...
wiced_bt_cfg_settings_t wiced_bt_cfg_settings =
{
    ...
    /* BLE advertisement settings */
    {
        ...
        .low_duty_min_interval           = 320,                                                     // Low duty undirected connectable minimum advertising interval. 2048 *0.625 = 1.28s
        .low_duty_max_interval           = 320, 
...
{
/*  { buf_size, buf_count } */
    { 68,  80 },      /* Small Buffer Pool */
    { 140, 40 },      /* Medium Buffer Pool (used for HCI & RFCOMM control messages, min recommended size is 360) */
    { 480, 10 },      /* Large Buffer Pool  (used for HCI ACL messages) */
    { 1160, 4 },      /* Extra Large Buffer Pool - Used for avdt media packets and miscellaneous (if not needed, set buf_count to 0) */
};
